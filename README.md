...
- Elimination mode, if only one letter or less than 10 possible solutions remain (adjustable in `config.json`), the solver will ignore the pattern and eliminate as many remaining letters as possible.
